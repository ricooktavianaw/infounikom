				...
				<div class="col-md-12">
					...
					<div class="widget">
						...
						<div class="widget-content">
							<form method="post" action="<?php echo base_url() ?>secuser/subevent/tambah_event" enctype="multipart/form-data">
								...
								<div class="form-group">
									...
									<input type="text" name="nama_sub_event" class="form-control">
								</div>
								<div class="form-group">
									<label>Tanggal</label>
								...
								<div class="form-group">
									<label>Jam</label>
									<input type="text" name="jam" class="form-control" placeholder="00:00:00">
								</div>
								<div class="form-group">
									<label>Lokasi</label>
