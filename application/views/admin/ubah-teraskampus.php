	...
	<div class="row">
		<div class="col-md-4 ">
			<ul class="breadcrumb">
				...
				<li><a href="<?php echo base_url() ?>secuser/subteraskampus/tambah">Ubah Teras Kampus</a></li>
			</ul>
		</div>
	</div>
				...
				<div class="col-md-12">
					...
					<div class="widget">
						...
						<div class="widget-content">
							...
							<form method="post" action="<?php echo base_url() ?>secuser/subteraskampus/ubah_teraskampus" enctype="multipart/form-data">
								<input type="hidden" value="<?php echo $wor->id_sub_teraskampus; ?>" name="id_sub_teraskampus" />
								...
								<div class="form-group">
									<label>Judul</label>
									<input type="text" name="nama_sub_teraskampus" class="form-control" value="<?php echo $wor->nama_sub_teraskampus ?>">
								</div>
								<div class="form-group">
