								...
								<div class="btn-group btn-group-xs">
									...
									<div class="btn-group  btn-group-xs">
										...
										<ul class="dropdown-menu pull-right">
											<li>
												<a href="index.html#">15 minutes later</a>
											</li>
											<li>
												<a href="index.html#">30 minutes later</a>
											</li>
											<li>
												<a href="index.html#">1 hour later</a>
											</li>
										</ul>
									</div>
								</div>
			...
			<div class="widget">
				<div class="widget-header">
					...
					<div class="btn-group widget-header-toolbar">
						<a href="index.html#" id="tour-focus" title="Focus" class="btn-borderless btn-focus"><i class="fa fa-eye"></i></a>
						<a href="index.html#" title="Expand/Collapse" class="btn-borderless btn-toggle-expand"><i class="fa fa-chevron-up"></i></a>
						<a href="index.html#" title="Remove" class="btn-borderless btn-remove"><i class="fa fa-times"></i></a>
					</div>
				</div>
				<div class="widget-content">
					<!-- chart tab nav -->
					<div class="chart-nav">
						...
						<ul id="sales-stat-tab">
							<li class="active">
								<a href="index.html#week">Weekly</a>
							</li>
							<li>
								<a href="index.html#month">Monthly</a>
							</li>
							<li>
								<a href="index.html#year">Annually</a>
							</li>
						</ul>
					</div>
					<!-- end chart tab nav -->
				...
				<div class="col-md-6">
					...
					<div class="widget widget-table">
						<div class="widget-header">
							...
							<div class="btn-group widget-header-toolbar">
								<a href="index.html#" title="Focus" class="btn-borderless btn-focus"><i class="fa fa-eye"></i></a>
								<a href="index.html#" title="Expand/Collapse" class="btn-borderless btn-toggle-expand"><i class="fa fa-chevron-up"></i></a>
								<a href="index.html#" title="Remove" class="btn-borderless btn-remove"><i class="fa fa-times"></i></a>
							</div>
							<div class="btn-group widget-header-toolbar">
				...
				<div class="widget-content">
					<table id="ticket-table" class="table table-sorting">
						...
						<tbody>
							<tr>
								<td>
									<a href="index.html#">[#18765]</a>
								</td>
								<td>Nov 21, 2013 15:45</td>
								<td>Front-End Site</td>
								<td>Smith</td>
								<td>
									<a href="index.html#">Product Review Problem</a>
								</td>
								<td>
							...
							<tr>
								<td>
									<a href="index.html#">[#18766]</a>
								</td>
								<td>Nov 21, 2013 16:12</td>
								<td>Technical Support</td>
								<td>Sean</td>
								<td>
									<a href="index.html#">Can't Download the Guide Doc</a>
								</td>
								<td>
							...
							<tr>
								<td>
									<a href="index.html#">[#18767]</a>
								</td>
								<td>Nov 21, 2013 16:43</td>
								<td>General Info</td>
								<td>Jane Doe</td>
								<td>
									<a href="index.html#">Regarding Customer Support</a>
								</td>
								<td>
									<span class="label label-medium">#5 - Medium</span>
								</td>
							...
							<tr>
								<td>
									<a href="index.html#">[#18768]</a>
								</td>
								<td>Nov 22, 2013 08:24</td>
								<td>General Info</td>
								<td>Smith</td>
								<td>
									<a href="index.html#">Can't Change My Address</a>
								</td>
								<td>
							...
							<tr>
								<td>
									<a href="index.html#">[#18769]</a>
								</td>
								<td>Nov 22, 2013 08:30</td>
								<td>Sales</td>
								<td>Smith</td>
								<td>
									<a href="index.html#">Review Tab Malfunction</a>
								</td>
								<td>
							...
							<tr>
								<td>
									<a href="index.html#">[#18770]</a>
								</td>
								<td>Nov 22, 2013 08:47</td>
								<td>Front-End Site</td>
								<td>John Doe</td>
								<td>
									<a href="index.html#">Broken Link</a>
								</td>
								<td>
							...
							<tr>
								<td>
									<a href="index.html#">[#18771]</a>
								</td>
								<td>Nov 23, 2013 14:08</td>
								<td>Sales</td>
								<td>Jack</td>
								<td>
									<a href="index.html#">Need Info About My Order Status</a>
								</td>
								<td>
							...
							<tr>
								<td>
									<a href="index.html#">[#18772]</a>
								</td>
								<td>Nov 23, 2013 17:45</td>
								<td>Techincal Support</td>
								<td>Darren</td>
								<td>
									<a href="index.html#">Bouncing Email</a>
								</td>
								<td>
									<span class="label label-critical">#1 - Critical</span>
								</td>
