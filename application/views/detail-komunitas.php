...
<div id="main">
    <div class="main-content">
        <div class="left-container">
            ...
            <article>
                <div class="title-box">
                    <h1><?php echo $row->nama_sub_komunitas ?></h1>
                </div>
                <div class="post-thumb">
                    <img src="<?php echo base_url().'pict/komunitas/'.$row->logo ?>" alt="">
                </div>
                <div class="post-info">
                    <ul>
                        <li>facebook<br><a href="<?php echo $row->facebook ?>"><span>Klik ini!</span></a></li>
                        <li>twitter<br><a href="<?php echo $row->twitter ?>"><span>Klik ini!</span></a></li>
                    </ul>
                    <div class="clear"></div>    
                </div>
                <div class="post-content">
                    <h3>Deskripsi Singkat</h3>
                    <div class="alert alert-block circ">
