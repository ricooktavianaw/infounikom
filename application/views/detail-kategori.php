...
<div id="main">
    <div class="main-content">
        <div class="left-container">
            ...
            <article>
                <div class="title-box">
                    <h1><?php echo $row->nama_sub_kategori ?></h1>
                </div>
                <div class="post-thumb">
                    <img src="<?php echo base_url().'pict/kategori/'.$row->pict ?>" alt="">
                </div>
                <div class="post-info">
                    <ul>
                        <li>kategori<br><span><?php echo $row->nama_kategori ?></span></li>
                        <li>author<br><span><?php echo $row->username ?></span></li>
                        <li>tanggal<br><span><?php echo Kategori::dateindo($row->waktu_post) ?></span></li>
                    </ul>
                    <div class="clear"></div>    
                </div>
                        ...
                        <div class="tab-pane active" id="tab-1">
                            <div class="news">
                                ...
                                <div class="item">
                                    ...
                                    <p><?php echo Kategori::dateindo($row->waktu_post) ?> // <?php echo $row->nama_kategori ?> // <?php echo $row->username ?></p>
                                    <div class="clear"></div>
                                </div>
                                <?php endforeach; ?>
                            </div>
