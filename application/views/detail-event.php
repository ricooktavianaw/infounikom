...
<div id="main">
    <div class="main-content">
        <div class="left-container">
            ...
            <article>
                <div class="title-box">
                    <h1><?php echo $row->nama_sub_event ?></h1>
                </div>
                <div class="post-thumb">
                    <img src="<?php echo base_url().'pict/event/'.$row->pict ?>" alt="">
                </div>
                <div class="post-info">
                    <ul>
                        <li>kategori <br><span><?php echo $row->nama_event ?></span></li>
                        <li>author<br><span><?php echo $row->username ?></span></li>
                        <li><?php echo $row->lokasi ?><br><span><?php echo Event::dateindo($row->tanggal).' || '.$row->jam ?></span></li>
                    </ul>
                    <div class="clear"></div>    
                </div>
                        ...
                        <div class="tab-pane active" id="tab-1">
                            <div class="news">
                                ...
                                <div class="item">
                                    ...
                                    <p><?php echo Event::dateindo($row->waktu_post) ?> // <?php echo $row->nama_kategori ?> // <?php echo $row->username ?></p>
                                    <div class="clear"></div>
                                </div>
                                <?php endforeach; ?>
                            </div>
