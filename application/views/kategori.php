    	...
    	<div class="left-container">
            ...
            <div class="row-fluid">
                <div class="span">
                    ...
                    <article class="small">
                        <div class="post-thumb">
                            <a href="<?php echo base_url().'kategori/detail/'.$row->id_sub_kategori ?>"><img src="<?php echo base_url().'pict/kategori/'.$row->pict ?>" alt=""></a>
                            <div class="overlay">
                                <div class="op"></div>
                                <div class="cat">
                                    <div class="icon"></div>
                        ...
                        <div class="cat-post-desc">
                            ...
                            <p>
                                <?php 
                                    ...
                                    echo "$content ...";
                                ?>
                                <a href="<?php echo base_url().'kategori/detail/'.$row->id_sub_kategori ?>">See Detail</a>
                            </p>
